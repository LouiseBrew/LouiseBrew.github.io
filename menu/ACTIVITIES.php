...
<div id="header-wrapper">
	<div id="header" class="container">
		<div id="logo">
			...
			<h1><a href="#">Office Activites</a></h1>
		</div>
		<div id="menu">
			<li><a href="index.php" accesskey="1" title=""><img src="images/home-icon.png" alt="home" style="width:50px; height:50px;"></a></li>

				<li><a href="OFFICES.php" accesskey="2" title=""><img src="images/office-icons.png" alt="office" style="width:50px; height:50px;"></a></li>

				<li><a href="ACTIVITIES.php" accesskey="3" title=""><img src="images/activity-icons.png" alt="activity" style="width:50px; height:50px;"></a></li>

				<li><a href="EMPLOYEE.php" accesskey="4" title=""><img src="images/employee-icon.png" alt="employee" style="width:50px; height:50px;"></a></li>
				
				<li><a href="CONTACT.php" accesskey="5" title=""><img src="images/contact-icon.jpg" alt="contact" style="width:50px; height:50px;"></a></li>

				<li><a href="LOCATION.php" accesskey="6" title=""><img src="images/location-icon.png" alt="location" style="width:50px; height:50px;"></a></li>

				<li><a href="../home.php" accesskey="7" title=""><img src="images/about-icon.png" alt="about" style="width:50px; height:50px;"></a></li>
...
<div class="wrapper">
	<div id="banner" class="container"><img src="" width="1200" height="500" alt="" /></div>
