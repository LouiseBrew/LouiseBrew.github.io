...
<div id="header-wrapper">
	<div id="header" class="container">
        ...
        <li><a href="CONTACT.php" accesskey="3" title=""><img src="images/contact-icon.jpg" alt="contact" style="width:50px; height:50px;"></a></li>

        <li><a href="../home.php" accesskey="4" title=""><img src="images/about-icon.png" alt="about" style="width:50px; height:50px;"></a></li>
        
        <li><a href="kiosk-login.php" accesskey="5" title=""><b>Login</b></a></li>
			</ul>
		</div>
	</div>
</div>
